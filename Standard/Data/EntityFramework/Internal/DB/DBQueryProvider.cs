...
namespace TraceCore.Standard.Data.EntityFramework.Internal.DB
{
    // <summary>
...
, IDbAsyncQueryProvider
#endif
    {
        ...
        internal static object GetIInternalQuery(IQueryable query)
        {
            ...
            else if (query is global::TraceCore.Data.IQuery)
            {
                return GetIInternalQuery(((query as global::TraceCore.Data.IQuery).Repository as RepositoryInternalBase).GetQuery());
            }
            else
            {
        ...
        public virtual IQueryable<TElement> CreateQuery<TElement>(Expression expression)
        {
            ...
            {
                return new QueryInternal<TElement>((IQueryable<TElement>)CreateQuery(objectQuery), _repository as global::TraceCore.Data.IRepository);
            }
            ...
            return new QueryInternal<TElement>(dbQuery, _repository as global::TraceCore.Data.IRepository);
        }
        ...
        public virtual IQueryable CreateQuery(Expression expression)
        {
            ...
            return new QueryInternal(CreateQuery(CreateObjectQuery(expression)), _repository as global::TraceCore.Data.IRepository);
        }

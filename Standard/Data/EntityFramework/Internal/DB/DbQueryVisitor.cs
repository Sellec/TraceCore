...
namespace TraceCore.Standard.Data.EntityFramework.Internal.DB
{
    ...
    internal class DbQueryVisitor : ExpressionVisitor
    {
        ...
        protected override Expression VisitMethodCall(MethodCallExpression node)
        {
            ...
            else if (typeof(global::TraceCore.Data.IRepository).IsAssignableFrom(node.Type) || node.Type.Name.StartsWith("RepositoryPropertyWrapper", StringComparison.OrdinalIgnoreCase))
            {
                var memberExpression = node.Object as MemberExpression;
                if (memberExpression != null)
                {

...
public static class TypesExtensions
{
    ...
    {
        if (type == null || type.BaseType == typeof(object) || !type.BaseType.IsClass) return Enumerable.Empty<Type>();

        return (new Type[] { type.BaseType }).ToList().Merge(type.BaseType.GetBaseTypes());
    }
}
